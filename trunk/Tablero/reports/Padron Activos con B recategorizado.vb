...
Public Class Padron_Activos_con_B_recategorizado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Padron Activos con B recategorizado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Renacer.Padron Activos con B recategorizado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_mes_año() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPadron_Activos_con_B_recategorizado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Padron_Activos_con_B_recategorizado = New Padron_Activos_con_B_recategorizado()
        rpt.Site = Me.Site
        Return rpt
    End Function
