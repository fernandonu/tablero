...
Public Class porcentaje_de_controles_por_efectorl
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "porcentaje de controles por efectorl.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Renacer.porcentaje de controles por efectorl.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedporcentaje_de_controles_por_efectorl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As porcentaje_de_controles_por_efectorl = New porcentaje_de_controles_por_efectorl()
        rpt.Site = Me.Site
        Return rpt
    End Function
