...
Partial Public Class srvIndicadores
    ...
    Sub bindIndicador()
        ...
        sqlString = "SELECT DISTINCT IndCod, IndNom, Valor, Tendencia, Estado, Meta1, Meta2, Meta3 FROM V_Indicadores " & wherestr & ""
        ...
        x.CommandText = "Select Count(*) From (Select distinct indcod From V_Indicadores " & wherestr & ") t"
        myConnection.Open()
