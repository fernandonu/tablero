...
Partial Public Class srvRecibidos
    ...
    Sub bindRecibidos()
        ...
        myAdapter.Fill(myDataSet, "Recibidos")
        ...
        For i = 0 To myDataSet.Tables(0).Rows.Count - 1
            ...
            Recibido = myDataSet.Tables(0).Rows(i).Item("Recibido").ToString()
            ...
            Esperado = CInt(Potencial * 0.3)
            Porcentaje = (CStr(Recibido / Potencial * 100)).Substring(0, 2)
            Recibido = CInt(Recibido * 0.3)


            Response.Write("<row id='" & Tipo & "'>")
            Response.Write("<cell>" & Tipo & "</cell>")
            Response.Write("<cell>" & Potencial & "</cell>")
            Response.Write("<cell>" & Esperado & "</cell>")
            Response.Write("<cell>" & Recibido & "</cell>")
