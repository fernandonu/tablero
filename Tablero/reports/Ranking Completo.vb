...
Public Class Ranking_Completo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Renacer.Ranking Completo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRanking_Completo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Ranking_Completo = New Ranking_Completo()
        rpt.Site = Me.Site
        Return rpt
    End Function
